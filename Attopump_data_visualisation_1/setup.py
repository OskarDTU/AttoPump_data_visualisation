...
if os.environ.get("ATTOPUMP_DATA_VISUALISATION_1_COMPILE_MYPYC") == "1":
...
def get_ext_modules():
    ...
    If the `ATTOPUMP_DATA_VISUALISATION_1_COMPILE_MYPYC` environment variable is set to "1",
    ...
    if os.environ.get("ATTOPUMP_DATA_VISUALISATION_1_COMPILE_MYPYC") == "1":
        ...
        # For example:
        # return mypycify([
        #     "src/Attopump_data_visualisation_1/__main__.py",
        #     "src/Attopump_data_visualisation_1/some_other_module.py",
        # ])
        return mypycify(
            [
                "src/Attopump_data_visualisation_1/__main__.py",
